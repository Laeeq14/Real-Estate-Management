...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="text-white">AMC Engineering College, Bangalore</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="text-white">+91 1122334455</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Address</h5>
										<span class="d-table text-white">help@realestatest.com</span>
										<span class="text-white">5B-B12@realestate.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
        ...
        <!--	Map -->
		<iframe src="https://www.google.com/maps/embed/v1/place?q=AMC+Engineering+College,+Bannerghatta+Road,+Bengaluru,+Karnataka,+India&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		<!--	Map -->
